/* ============================================================
   ...
   `useTodayISO` 는 이 이벤트를 **"무언가 바뀌었으니 다시 판정"** 의 여러 트리거 중 하나로
   쓴다(`focus`·`blur`·`reduce.change` 와 **같은 핸들러**를 공유한다).
   (⚠ 종전엔 `components/AmbientCanvas` 가 같은 부류로 함께 적혀 있었다 — I045 가 그 컴포넌트를
   걷어 지금은 0개다. 형태는 남아 있으므로 예시만 줄였다 · C060/C061 · 2026-08-22.)
