...
export const TABS: TabMeta[] = [
  ...
  { key: 'control', label: '시스템 제어판', group: 'src', order: 55, icon: 'gear' },
  ...
  { key: 'mastery', label: '숙달도 지도', group: 'log', order: 85, icon: 'chart' },
  { key: 'degreeReq', label: '졸업요건 정리', group: 'degree', order: 90, icon: 'clipboard' },
  { key: 'degree', label: '졸업 계획', group: 'degree', order: 100, icon: 'cap' },
