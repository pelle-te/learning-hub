...
const GAP = 8;
const TIP =
  'pointer-events-none fixed z-[var(--z-tooltip)] max-w-tooltip -translate-x-1/2 rounded-sm border border-line bg-panel px-2.5 py-1.75 text-sm leading-[1.45] break-keep whitespace-pre-line text-txt shadow-float animate-[tt-fade-in_0.12s_var(--ease)_both] motion-reduce:animate-none';
