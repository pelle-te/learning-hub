...
const GAP = 8;
const TIP =
  'pointer-events-none fixed z-[var(--z-tooltip)] max-w-tooltip -translate-x-1/2 rounded-sm border border-line bg-panel px-2.5 py-1.75 text-sm leading-snug break-keep whitespace-pre-line text-txt shadow-float animate-[enter-fade_var(--dur-fast)_var(--ease)_both] motion-reduce:animate-none';
